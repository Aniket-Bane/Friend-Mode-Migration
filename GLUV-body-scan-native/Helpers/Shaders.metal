...
vertex void unprojectVertex(uint vertexID [[vertex_id]],
    ...
    particleUniforms[currentPointIndex].confidence = confidence;
        particleUniforms[currentPointIndex].isfar = 0;
        particleUniforms[currentPointIndex].isnear = 0;
    }else if (depth >= 0.7) {
        particleUniforms[currentPointIndex].isfar = 1;
        particleUniforms[currentPointIndex].isnear = 0;
    }else {
        particleUniforms[currentPointIndex].isnear = 1;
        particleUniforms[currentPointIndex].isfar = 0;
    }
    }
